...
const FALLBACK_DATA = {
  ...
  months: [
    ...
    { month: '2026-05', details: [
      {date:'2026-05-02',type:'income',category:'住宿',item:'陳俊杰 尾款',amount:14000},
      {date:'2026-05-15',type:'income',category:'住宿',item:'Yi等3位 住宿與SUP',amount:7800},
      {date:'2026-05-01',type:'income',category:'住宿/烤肉',item:'4間房、烤肉及雜項 尾款',amount:22685},
      {date:'2026-05-30',type:'income',category:'住宿',item:'6大3小 尾款',amount:14500},
      {date:'2026-05-30',type:'income',category:'住宿',item:'章智傑 櫻花兩人雅房',amount:2000},
      {date:'2026-05-31',type:'income',category:'住宿',item:'陳星妤 尾款（扣動滋卷$1000）',amount:2000},
      {date:'2026-05-01',type:'expense',category:'烤肉/食材',item:'青菜',amount:2000},
      {date:'2026-05-01',type:'expense',category:'烤肉/食材',item:'海鮮',amount:700},
      {date:'2026-05-16',type:'expense',category:'烤肉/食材',item:'海鮮',amount:1000},
      {date:'2026-05-16',type:'expense',category:'烤肉/食材',item:'豬肉',amount:4000},
      {date:'2026-05-16',type:'expense',category:'烤肉/食材',item:'五金',amount:1500},
      {date:'2026-05-16',type:'expense',category:'烤肉/食材',item:'青菜',amount:1500},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'青菜飲料',amount:2000},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'海鮮',amount:600},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'泡麵',amount:136},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'蛋',amount:49},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'青菜',amount:690},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'青菜',amount:1300},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'豬肉',amount:550},
      {date:'2026-05-23',type:'expense',category:'烤肉/食材',item:'烤雞',amount:1300},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'秋蓮 杯裝',amount:330},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'秋蓮 紅茶包',amount:3400},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'秋蓮 包船（4/25）',amount:10000},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'草屯肥料',amount:300},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'貓飼料',amount:1500},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'茶米工務車維修保養',amount:3000},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'金紙',amount:209},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'拜拜用品',amount:200},
      {date:'2026-05-01',type:'expense',category:'雜費',item:'卡達加油',amount:1500},
      {date:'2026-05-20',type:'expense',category:'雜費',item:'代買 牛排',amount:1870},
      {date:'2026-05-20',type:'expense',category:'雜費',item:'代買 鐵板麵',amount:80},
      {date:'2026-05-20',type:'expense',category:'雜費',item:'代買 滷味',amount:135},
      {date:'2026-05-20',type:'expense',category:'雜費',item:'代買 山東鴨頭',amount:550},
      {date:'2026-05-01',type:'expense',category:'早餐',item:'早餐',amount:1045},
      {date:'2026-05-02',type:'expense',category:'早餐',item:'早餐',amount:1700},
      {date:'2026-05-19',type:'expense',category:'早餐',item:'早餐',amount:1300},
      {date:'2026-05-25',type:'expense',category:'早餐',item:'早餐',amount:700},
      {date:'2026-05-30',type:'expense',category:'早餐',item:'早餐',amount:1100},
      {date:'2026-05-31',type:'expense',category:'早餐',item:'早餐',amount:600},
      {date:'2026-06-16',type:'expense',category:'早餐',item:'早餐',amount:220},
      {date:'2026-06-23',type:'expense',category:'早餐',item:'早餐',amount:1500},
      {date:'2026-05-01',type:'expense',category:'房務',item:'房務',amount:3000}
    ]}
  ]
};
